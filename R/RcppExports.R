...
CARPcpp <- function(X, D, weights, epsilon, t, rho = 1, max_iter = 10000L, burn_in = 50L, back = 0.5, keep = 10L, viz_max_inner_iter = 15L, viz_initial_step = 1.1, viz_small_step = 1.01, l1 = FALSE, show_progress = TRUE, back_track = FALSE, exact = FALSE) {
    .Call('_clustRviz_CARPcpp', PACKAGE = 'clustRviz', X, D, weights, epsilon, t, rho, max_iter, burn_in, back, keep, viz_max_inner_iter, viz_initial_step, viz_small_step, l1, show_progress, back_track, exact)
}

CBASScpp <- function(X, D_row, D_col, weights_col, weights_row, epsilon, t, rho = 1, max_iter = 10000L, burn_in = 50L, back = 0.5, keep = 10L, viz_max_inner_iter = 15L, viz_initial_step = 1.1, viz_small_step = 1.01, l1 = FALSE, show_progress = TRUE, back_track = FALSE, exact = FALSE) {
    .Call('_clustRviz_CBASScpp', PACKAGE = 'clustRviz', X, D_row, D_col, weights_col, weights_row, epsilon, t, rho, max_iter, burn_in, back, keep, viz_max_inner_iter, viz_initial_step, viz_small_step, l1, show_progress, back_track, exact)
}

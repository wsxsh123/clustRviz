...
// CARPcpp
Rcpp::List CARPcpp(const Eigen::MatrixXd& X, const Eigen::MatrixXd& D, const Eigen::VectorXd& weights, double epsilon, double t, double rho, int max_iter, int burn_in, double back, int keep, int viz_max_inner_iter, double viz_initial_step, double viz_small_step, bool l1, bool show_progress, bool back_track, bool exact);
RcppExport SEXP _clustRviz_CARPcpp(SEXP XSEXP, SEXP DSEXP, SEXP weightsSEXP, SEXP epsilonSEXP, SEXP tSEXP, SEXP rhoSEXP, SEXP max_iterSEXP, SEXP burn_inSEXP, SEXP backSEXP, SEXP keepSEXP, SEXP viz_max_inner_iterSEXP, SEXP viz_initial_stepSEXP, SEXP viz_small_stepSEXP, SEXP l1SEXP, SEXP show_progressSEXP, SEXP back_trackSEXP, SEXP exactSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(CARPcpp(X, D, weights, epsilon, t, rho, max_iter, burn_in, back, keep, viz_max_inner_iter, viz_initial_step, viz_small_step, l1, show_progress, back_track, exact));
    return rcpp_result_gen;
END_RCPP
}
// CBASScpp
Rcpp::List CBASScpp(const Eigen::MatrixXd& X, const Eigen::MatrixXd& D_row, const Eigen::MatrixXd& D_col, const Eigen::VectorXd& weights_col, const Eigen::VectorXd& weights_row, double epsilon, double t, double rho, int max_iter, int burn_in, double back, int keep, int viz_max_inner_iter, double viz_initial_step, double viz_small_step, bool l1, bool show_progress, bool back_track, bool exact);
RcppExport SEXP _clustRviz_CBASScpp(SEXP XSEXP, SEXP D_rowSEXP, SEXP D_colSEXP, SEXP weights_colSEXP, SEXP weights_rowSEXP, SEXP epsilonSEXP, SEXP tSEXP, SEXP rhoSEXP, SEXP max_iterSEXP, SEXP burn_inSEXP, SEXP backSEXP, SEXP keepSEXP, SEXP viz_max_inner_iterSEXP, SEXP viz_initial_stepSEXP, SEXP viz_small_stepSEXP, SEXP l1SEXP, SEXP show_progressSEXP, SEXP back_trackSEXP, SEXP exactSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type back_track(back_trackSEXP);
    Rcpp::traits::input_parameter< bool >::type exact(exactSEXP);
    rcpp_result_gen = Rcpp::wrap(CBASScpp(X, D_row, D_col, weights_col, weights_row, epsilon, t, rho, max_iter, burn_in, back, keep, viz_max_inner_iter, viz_initial_step, viz_small_step, l1, show_progress, back_track, exact));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    {"_clustRviz_CARPcpp", (DL_FUNC) &_clustRviz_CARPcpp, 17},
    {"_clustRviz_CBASScpp", (DL_FUNC) &_clustRviz_CBASScpp, 19},
